...
def Facewash():
    ...
    # 3rd
    l5 = Label(MAIN_WINDOW, text="3. How does your skin react to 2 hours of sun exposure without sunscreen?",
               justify=LEFT)
    l5.pack(anchor=W)
    v5 = IntVar()
...
def Denims():
    ...
    Radiobutton(MAIN_WINDOW, text='When my current pair cannot be worn anymore', variable=v7, value=3, command=c3).pack(
        anchor=W)
